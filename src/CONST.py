...
# Geographic region boundaries (degrees)
...
MIN_MAGNITUDE = 1       # Minimum magnitude
...
# The formula calculates the distance corresponding to one degree difference in coordinates,
